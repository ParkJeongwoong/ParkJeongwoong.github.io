...
// EXTERNAL MODULE: ./src/store/article_data.js + 2 modules
var article_data = __webpack_require__(6437);
...
const StateProvider = ({
  ...
  const {
    ...
    switch (action.type) {
      ...
      case "GET_ARTICLES":
        const articles = article_data/* default */.Z;
